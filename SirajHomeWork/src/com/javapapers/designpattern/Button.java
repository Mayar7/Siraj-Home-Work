...
public class Button implements SubjectDesignPattern{
	private char LetterButton;
	Date date=new Date(); 
	...
	public void setButton(char button) {
		this.LetterButton = button;
	}
	//Function for the Button A
